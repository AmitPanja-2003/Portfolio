  ...
  return (
    <div className={styles.aboutContainer}>
      ...
      <div className={styles.textSection}>
        <h2>About Me</h2>
        <p>
          Hi, I'm Amit, a passionate Computer Science Engineer and
          aspiring Full-Stack Developer. I specialize in Java, React, and
          MongoDB, building efficient and user-friendly web applications. I
          ...
          coding, I love to learning new frameworks, and
          contributing to open-source projects. Let's connect and build
